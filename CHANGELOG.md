...
- **iOS: capture transactions through the Shortcuts app** — Hisabak now provides a
  ...
  messages. The action reports honestly — "Transaction saved", "Saved to your SMS inbox for
  review", or "Already captured" — and returns a needs-review flag your shortcut can branch
  on; a companion "Open SMS inbox" action jumps straight to the review screen.
