...
fun TransactionEditRoute(
    ...
    TransactionEditScreen(
        ...
        onSmartInputChange = { viewModel.onIntent(TransactionEditIntent.SmartInputChanged(it)) },
        onSmartParse = { viewModel.onIntent(TransactionEditIntent.SmartParseRequested) },
        onCreateSuggestedBrand = { viewModel.onIntent(TransactionEditIntent.CreateSuggestedBrand) },
